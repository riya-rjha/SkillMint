  ...
  const features = [
    {
      ...
      description: "Direct connection between learners and course creators on the blockchain."
    },
    {
    ...
    },
    {
      ...
      description: "Course creators earn directly from their content, no middlemen."
    }
  ];
    ...
    <main className="container mx-auto px-4 py-16">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold mb-6">
          Learn, Earn, and Grow on the <span className="text-[#3FA37A]">Blockchain</span>
        </h1>
